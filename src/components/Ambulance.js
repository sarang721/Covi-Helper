...
function Ambulance() {
    ...
    const addambulance=async()=>{
        ...
        db.collection("ambulanceforpatients")
        .doc()
        .set({
            ambulancenumber:number,
            name:name,
...
<div className="dashhome">
            ...
            <input type="text" value={number}  onChange={(e)=>setnumber(e.target.value)}  className="inptext" />
        
            <label className="fname">Enter Driver Name</label>
            <input type="text"  value={name}  onChange={(e)=>setname(e.target.value)} className="inptext"   />

             <label className="fname">Enter Driver Number</label>
            <input type="text"  value={phoneno}  onChange={(e)=>setphoneno(e.target.value)} className="inptext" />
            </div>

            <input type="submit"  onClick={addambulance}   className="subbtn3" value="Add"/>
