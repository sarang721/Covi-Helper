...
const getdata=async()=>{
    ...
    const setavailability=async()=>{
        ...
        try{
            ...
            .update({
                ...
                ticunonventi:fticunonventi===undefined?ticunonventi:fticunonventi,
    ...
    return (
        ...
        <div className="dashhome">
            ...
            <input type="text"  className="inptext" value={ftwithoxy} onChange={(e)=>fsettwithoxy(e.target.value)}  placeholder={twithoxy} name="a"/>
        
            <label className="fname">Enter Oxygen Beds Available</label>
            <input type="text"  className="inptext" value={foxy} onChange={(e)=>fsetoxy(e.target.value)}  placeholder={oxy} />

             <label className="fname">Enter Total Non-Oxygen Beds Available</label>
            <input type="text"  className="inptext" value={ftwithoutoxy} onChange={(e)=>fsettwithoutoxy(e.target.value)}  placeholder={twithoutoxy} />
            
            <label className="fname">Enter Non-Oxygen Beds Available</label>
            <input type="text"  className="inptext" value={fnonoxy} onChange={(e)=>fsetnonoxy(e.target.value)}  placeholder={nonoxy} />
            
            
            <label className="fname">Enter Total ICU With Ventilators</label>
            <input type="text"  className="inptext" value={fticuventi} onChange={(e)=>fsetticuventi(e.target.value)}  placeholder={ticuventi} />
            
            <label className="fname">ICU With Ventilators Available</label>
            <input type="text"  className="inptext" value={ficuventi} onChange={(e)=>fseticuventi(e.target.value)}  placeholder={icuventi} />
            
            <label className="fname">Enter Total ICU  Without Ventilators</label>
            <input type="text"  className="inptext" value={fticunonventi} onChange={(e)=>fsetticunonventi(e.target.value)}  placeholder={ticunonventi} />
            
            <label className="fname">Total ICU  Without Ventilators Available</label>
            <input type="text"  className="inptext" value={ficunonventi} onChange={(e)=>fseticunonventi(e.target.value)}  placeholder={icunonventi} />
            


            <input type="submit" onClick={setavailability}   className="subbtn" value="Submit"/>
