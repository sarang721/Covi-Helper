...
function DashHome() {
    ...
    const getambreq=async()=>{
        ...
        const temp=[];
        await db.collection("patientscall")
        .get()
        .then((snapshot)=>{
...
<h2 className="addetail">Ambulance Requests</h2>
            ...
            <div className="requests">
                {
                    ambulancerequests.length===0?<h2 style={{fontWeight:100}}>No data </h2>:
...
<label className="fname">City Where hospital located</label>
    <input type="text"  className="inptext"  placeholder={city && city.toUpperCase()} readOnly/>


    <label className="fname">Hospital Address</label>
    <input type="text"  className="inptext"  placeholder={address && address.toUpperCase()}  readOnly/>
    ...
    <input type="text" id="lname" className="inptext" name="lastname" placeholder={longi}  readOnly/>

    <label className="fname">Contact Info </label>
    <input type="text" id="lname" className="inptext" name="lastname" placeholder={contact}  readOnly/>


    <label className="fname">Hospital Type</label>
    <input type="text" id="lname" className="inptext" name="lastname" placeholder={type && type.toUpperCase()}  readOnly/>

    <Link to="/address"><input type="submit"  className="subbtn1" value="Update"/></Link>
        ...
        <h2 className="addetail">Bed Availability Details</h2>
            <div className="dashhome">
                ...
                <div className="card1" >
                    ...
                    <Card title="Non Oxygen Beds" data1={nonoxy} data2={twithoutoxy} ></Card>

                </div>

                <div className="card1" >
                    <Card title="ICU With Ventilators" data1={icuventi} data2={ticuventi} ></Card>
                    <Card title="ICU Without Ventilators" data1={icunonventi} data2={ticunonventi}></Card>

                </div>

                <Link to="/beds"><input type="submit"  className="subbtn1" value="Update"/></Link>
            ...
            <div className="dashhome">
                ...
                <Link to="/plasma"><input type="submit"  className="subbtn1" value="Update"/></Link>
            ...
            <label className="fname">IS RAT Facility Available?</label>
                <input type="text"  className="inptext"  placeholder={rat && rat.toUpperCase()}  readOnly/>

                
                <Link to="/rattest"><input type="submit"  className="subbtn1" value="Update"/></Link>
...
<div className="dashhome">
    ...
    {
        ambdata.length===0?<div>No Data</div>:(
        ambdata.map((val,key)=>{
    ...
    <Link to="/ambulance"><input type="submit"  className="subbtn1" value="Add Ambulance"/></Link>
